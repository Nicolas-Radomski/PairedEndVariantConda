...
- This workflow run reference indexing for BWA/Picard/Samtools (step 1_reference), BBnorn (step 1_normalization), Trimmomatic (step 2_trimming), BWA and Picard (4_mapping), GATK4 (5_calling) and quality assessment of mapping with Samtools (6_quality) based on paired-end reads from a single genomic sample, successively.
